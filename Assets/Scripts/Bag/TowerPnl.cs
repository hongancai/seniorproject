...
public class TowerPnl : MonoBehaviour
{
    public RectTransform panelRectTransform;
    public Button expandButton; // 朝右箭頭按鈕
    public Button collapseButton; // 朝左箭頭按鈕

    public float expandedPosy = 153f;
    public float collapsedPosy = -76f;
    ...
    private void Awake()
    {
        ...
        initialPosition.y = isExpanded ? expandedPosy : collapsedPosy;
    ...
    public void ExpandPanel()
    {
        ...
        // 使用DoTween移動面板到展開位置
        panelRectTransform.DOAnchorPosY(expandedPosy, animationDuration)
    ...
    public void CollapsePanel()
    {
        ...
        // 使用DoTween移動面板到收縮位置
        panelRectTransform.DOAnchorPosY(collapsedPosy, animationDuration)
            .SetEase(animationEase)
            .OnComplete(() => {
                isExpanded = false;
                UpdateButtonsState();
