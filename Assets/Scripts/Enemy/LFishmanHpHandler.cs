...
public class LFishmanHpHandler : MonoBehaviour
{
    ...
    private void Die()
    {
        ...
        LFishmanMgr lfisnmanManager = GetComponentInParent<LFishmanMgr>();
        if (lfisnmanManager != null)
        {
            lfisnmanManager.SetDead();
        }
