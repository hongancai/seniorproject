...
public class LSoldierHpHandler : MonoBehaviour
{
    ...
    public void TakeDamage(float damage)
    {
        ...
        // 計算實際傷害 (考慮防禦力)
        float actualDamage = Mathf.Max(1, damage - GameDB.soilder.enemybased.Def);
    ...
    private void Die()
    {
        ...
        LSoldierMgr lsoldierManager = GetComponentInParent<LSoldierMgr>();
        if (lsoldierManager != null)
        {
            lsoldierManager.SetDead();
        }
