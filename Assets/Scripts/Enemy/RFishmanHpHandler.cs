...
public class RFishmanHpHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 從GameDB獲取鳥敵人的最大血量
        maxHP = GameDB.fishman.enemybased.HP;
        currentHP = maxHP;
    ...
    public void TakeDamage(float damage)
    {
        ...
        // 計算實際傷害 (考慮防禦力)
        float actualDamage = Mathf.Max(1, damage - GameDB.fishman.enemybased.Def);
    ...
    private void Die()
    {
        ...
        RFishmanMgr rfisnmanManager = GetComponentInParent<RFishmanMgr>();
        if (rfisnmanManager != null)
        {
            rfisnmanManager.SetDead();
        }
